...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header"><h1>Login As Pateint</h1></div>
      <div class="card-body">
        ...
        <div class="text-center">
          ...
          <a class="d-block small" href="forgot-password.html">Forgot Password?</a>
           ...
           <div align="center"><br><form>
        	<button ><a href ="http://localhost/kyd6/doctor/login1.php">  Login As Doctor</a></button><br><?php echo" <br>";?>
        	<button ><a href ="http://localhost/kyd6/chemist1/login1.php">  Login As Chemist</a></button><br><?php echo" <br>";?>
        	<button  ><a href ="http://localhost/kyd6/labtec/login1.php">Login As LabTechnician</a></button><br><br><br>
