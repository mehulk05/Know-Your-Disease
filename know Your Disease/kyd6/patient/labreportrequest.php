...
echo "<h1> <center>List Of Approoved Tests</center></h1><br> ";
echo "<table><tr>";

  $result=mysql_query("SELECT * FROM lab_report_request where Patient_Mail='$id'");
        if($result === FALSE) { 
 ...
 echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>";
  ...
  echo $row['Reports'];
  echo "</td><td>";
  echo $row['Patient_Mail'];
  echo "</td><td>";
  echo $row['Dcotor_Mail'];
  echo "</td><td>";
   echo $row['date'];
  echo "</td><td>";
  echo $row['status'];
...
<?php
       ...
       echo "<tr>";?>
    <button >
    <a href ="appointmentreqforlab.php?email=<?php echo $email;?>&id=<?php echo $row['id'];?>">  Request Appointment for Lab Test</a></button><br>
        <?php echo"</td><td>";?>
