...
echo "<div style='margin-left: 0px;margin-right: 100px;  font-family:monospace; font-size: 15pt'>";
echo "<h1> <center>List Of Ordered Medicines</center></h1><br> ";
echo "<table><tr>";

  $result=mysql_query("SELECT * FROM order1 where patientemail='$id'");
 echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>";
      ...
      <th>Address</td> 
      <th>Time</td>
      <th colspan='2'>Approved Order </td>
        </tr>";
...
<div class="w3-content w3-display-container">
  <img class="mySlides" src="C:\xampp\htdocs\New folder\h1.jpg" style="width:100%">
  <img class="mySlides" src="C:\xampp\htdocs\New folder\h2.jpg" style="width:100%">
