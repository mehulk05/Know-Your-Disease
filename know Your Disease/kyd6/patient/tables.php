  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"></li>Search
      </ol>
	  
	
  
	  <div style="margin-left: 80px;margin-right: 180px;  font-family:monospace; font-size: 17pt">
	 
	
		 <br> Explain Your Health Problem 
		 	<form action="as.php" method="POST">
	  <textarea name="tname" cols="5"></textarea> 
		<br><br>
	    <div class="tab">
  <button class="tablinks"  >Search</button></div>
  <br></form>
