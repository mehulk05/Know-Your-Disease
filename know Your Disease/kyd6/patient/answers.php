...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <br>
    <div align="center">
    <h1> Answers To Your Asked Questions</h1>
...
mysql_select_db("kyd", $con);
    ...
    $sql = "SELECT * FROM kyd.docreply WHERE email='$id'";
...
<table border='1' cellspacing='20' width='812' id='yourTbl'>

  <tr>
    
    <th  bgcolor='green'><center><font color='white'>#-Id</font></center></th>
    <th bgcolor='green'><center><font color='white'>Name</font></th>
    <th bgcolor='green'><center><font color='white'>Answers</font></th>
    </tr>
