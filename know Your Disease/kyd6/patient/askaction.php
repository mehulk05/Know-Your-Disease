...
$str="insert into askquestion values('$question','$name','$email')";
$res=@mysql_query($str)or die(mysql_error());
if($res>=0)
{
echo    '<br><br><b>Thank you for Asking Question !! <br><br>
			We will Conatc you Soon';
...
$query=mysql_query("select *  from askquestion where email='$email'");
...
$mail = new PHPMailer();
  ...
  $mail->Subject = "Question asked by Paitent";
  $mail->Body = "<i>Question is </i>".$row["question"];
  $mail->AltBody = "Question asked by patient is";
  if(!$mail->send())
  {
