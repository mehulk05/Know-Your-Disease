...
<form action="orderaddress.php" method="post">
	<h2>Enter your address</h2>

	Only cod is availabale<input type="textarea" name="ta" placeholder="aap ka ashiyana?" required>
	<input type="submit" name="bt1" value="place order" onclick="function1()">
	</form>
