...
$sql="SELECT * FROM kyd.askquestion WHERE id ='$id'";
...
?>
<form role="form" method="post" id="reused_form" action="replyaction.php">
                       
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label for="comments"> Your Answer</label>
                                <textarea class="form-control" type="textarea" name="question" id="comments" placeholder="Your Comments" maxlength="6000" cols="20" rows="20"></textarea>
                            </div>
                        </div>
                        <div class="row">
