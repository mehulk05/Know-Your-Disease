...
echo "<table><tr>";
	...
	$result=mysql_query("SELECT name,date,email,symptoms FROM appointment");
 echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>";
	...
	while ($row = mysql_fetch_array($result))   
   {
	...
	<form onsubmit ="bs.php">
		<button >
		<a href ="bs.php?id= <?php echo $s;?> name=<?php echo $row['name']; ?>">  Confirm</a></button><br>
        <?php echo"</td><td>";?>
        <button >
		<a href ="cancel.php?id= <?php echo $s; ?>">  Cancel</a></button>
	</form>
