  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ask Your Questions</li>
      </ol>
	
	<form role="form" method="post" id="reused_form" action="askaction.php">
                       
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label for="comments"> Ask your Question:</label>
                                <textarea class="form-control" type="textarea" name="question" id="comments" placeholder="Your Comments" maxlength="6000" rows="7"></textarea>
                            </div>
                        </div>
                        <div class="row">
