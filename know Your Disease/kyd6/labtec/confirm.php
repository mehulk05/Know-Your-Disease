...
$sql = "UPDATE  lab_report_request SET status='yes' WHERE id='$id'";
...
$mail = new PHPMailer();
  ...
  $mail->Body = "<b>Yor request for given lab report test has been approved and will notify you once all test has beedn done</b>";
