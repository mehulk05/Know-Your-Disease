...
$mail = new PHPMailer();
  ...
  $mail->Body = "<b>Your Appointment has been Canceled Due to Busy Schedules of LabTechnicians..</b>".$row["password"];
  ...
  <button >
    <a href = "appointmentreq.php">  Confirmed And Go BAck</a></button><br>
<?php
  }
