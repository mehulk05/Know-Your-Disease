...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">Welcome <?php echo  $id ;?> </a>
    <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="chemistindex.html">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="reportdisplay.php">Request For Reports</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
         ...
         <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              <a href="appointmentreq.php">  Appointment Request</a>
            </li>
            <li>
...
<img src="upload3.php" width="20%" height="50%" /><br><br>
<a href="charts.php">Upload a Picture?</a>&nbsp
 &nbsp&nbsp   <a href="facafterlog.php">change the Picture?</a>
    
<?php


 $result3 = mysql_query("SELECT * FROM kyd.labreg WHERE email='$id'");
if (!$result3) {
    die(mysql_error());
}
...
<table width="398" border="0" align="center" cellpadding="0">
  <tr>
    <td height="26" colspan="2"><h3>Your Profile </h3> </td>
	<td width="165" valign="top"></h5></td><br>
	<td width="565" valign="top"><button type="button"><a href="editprofile.php">Edit Profile</a></button><br>
  </tr>
